...
enum PromptBuilder {
    ...
    - UI 문자열(버튼, 메뉴)은 한국어 UI 관례에 맞춘다 (예: "Save" → "저장", "Deleted" → "삭제됨").
    - 짧은 단어나 단편이라도 가능한 가장 자연스러운 한국어로 번역한다.
    ...
    - Translate even short words or fragments into the most natural English rendering.
